...
const ADMOB_IDS = {
  REWARDED: 'ca-app-pub-1136319708640770/1949753984',         // Rewarded
  REWARDED_VIDEO: 'ca-app-pub-1136319708640770/5697427301',   // Rewarded 2 (for coins, spins, double rewards)
  REWARDED_INTERSTITIAL: 'ca-app-pub-1136319708640770/7613744244', // Rewarded Interstitial
  INTERSTITIAL: 'ca-app-pub-1136319708640770/7010508972',     // Interstitial
  BANNER: 'ca-app-pub-1136319708640770/3885652182',           // Banner Ad
};
...
export const AD_UNIT_IDS = {
  ...
  REWARDED_INTERSTITIAL: IS_PRODUCTION ? ADMOB_IDS.REWARDED_INTERSTITIAL : TEST_AD_IDS.INTERSTITIAL,
